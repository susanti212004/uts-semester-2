...
public class susanti {
    public static void main(String[] args) throws Exception{
        ArrayList<susan> zakatList = new ArrayList<>();
        ...
        do {
            ...
            if (jenisZakat.equalsIgnoreCase("fitrah")) {
                ...
                susan zakatFitri = new susan(nama, alamat, jenisZakat, jumlahBeras, jumlahZakat);
                zakatList.add(zakatFitri);
            } else if (jenisZakat.equalsIgnoreCase("sedekah")) {
                double jumlahZakat = jumlahUang;

                susan zakatFitri = new susan(nama, alamat, jenisZakat, jumlahUang, jumlahZakat);
                zakatList.add(zakatFitri);
            }
